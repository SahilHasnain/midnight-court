...
export default function EditorScreen() {
      ...
      try {
        ...
        if (saved) {
          ...
          if (data.slides) {
            ...
            console.log(
              "✅ Loaded saved presentation with",
              data.slides.length,
              "slides"
            );
          }
        ...
        setSlides([
          {
            title: "",
            subtitle: "",
            blocks: [createDefaultBlock(BLOCK_TYPES.TEXT)],
          },
        ]);
        setCurrentSlideIndex(0);
  ...
  const deleteBlock = (blockId) => {
    const newBlocks = currentSlide.blocks.filter(
      ...
      >
        ...
        <View style={styles.slideNav}>
          ...
          >
            <Text
              style={[
                styles.navText,
                currentSlideIndex === 0 && styles.navTextDisabled,
              ]}
            >
              ‹ Prev
            </Text>
        ...
        <View style={styles.editorContent}>
            ...
            <View style={styles.sectionHeader}>
              <View>
                ...
                <Text style={styles.hint}>
                  Optional: Use *gold* ~red~ _blue_ for emphasis
                </Text>
              </View>
              <TouchableOpacity
              ...
              <View style={styles.subtitlePreview}>
                {currentSlide.subtitle ? (
                  <Text style={styles.subtitlePreviewText}>
                    {parseFormattedText(currentSlide.subtitle).map(
                      (part, idx) => (
                        <Text
                          key={idx}
                          style={{
                            color: part.color || colors.textSecondary,
                            fontWeight: "500",
                          }}
                        >
                          {part.text}
                  ...
                  <Text
                    style={[
                      ...
                      { opacity: 0.4, color: colors.textSecondary },
                    ]}
                  >
          ...
          >
            ...
            <View style={styles.addBlockTextContainer}>
              ...
              <Text style={styles.addBlockSubtitle}>
                Choose from text, quotes, timelines & more
              </Text>
            </View>
          ...
          >
            ...
            <View style={styles.addBlockTextContainer}>
              ...
              <Text style={styles.addBlockSubtitle}>
                AI creates slides from case description
              </Text>
            </View>
            <Text style={styles.addBlockArrow}>›</Text>
          </TouchableOpacity>
              ...
              <View style={styles.slideActionRow}>
                <TouchableOpacity
                  ...
                  style={[
                    ...
                    currentSlideIndex === 0 && styles.slideActionButtonDisabled,
                  ]}
                  disabled={currentSlideIndex === 0}
                >
                  <Text style={styles.slideActionIcon}>⬆️</Text>
                ...
                <TouchableOpacity
                  ...
                  style={[
                    styles.slideActionButton,
                    currentSlideIndex === slides.length - 1 &&
                      styles.slideActionButtonDisabled,
                  ]}
                  disabled={currentSlideIndex === slides.length - 1}
                >
                  <Text style={styles.slideActionIcon}>⬇️</Text>
            ...
            {slides.length > 1 && (
              <View style={styles.slideActionRow}>
                <TouchableOpacity
                  ...
                  style={[
                    styles.slideActionButton,
                    styles.slideActionButtonFull,
                    styles.slideActionButtonDanger,
                  ]}
                >
                  <Text style={styles.slideActionIcon}>🗑️</Text>
          ...
          <GoldButton title="Continue to Export" onPress={goToExport} />
        </View>
        ...
        <CitationSearchModal
          ...
          onSelectCitation={(citation) => {
            ...
            const quoteText =
              citation.summary || citation.text || citation.author;
          ...
          onUseSlides={(generatedSlides) => {
            ...
            const processedSlides = generatedSlides.map((slide, slideIndex) => {
              ...
              if (slide.suggestedImages && slide.suggestedImages.length > 0) {
                ...
                const layout =
                  slideIndex % 2 === 0 ? "floatRight" : "floatLeft";
            ...
            setCurrentSlideIndex(0);
            showToastMessage(
              `✅ Loaded ${processedSlides.length} slides! Tap image placeholders to add images.`
            );
          }}
        />
      </ScrollView>
